...
class PolylgonsPolyLines extends StatefulWidget {
  @override
  _PolylgonsPolyLinesState createState() => _PolylgonsPolyLinesState();
}

class _PolylgonsPolyLinesState extends State<PolylgonsPolyLines> {
...
//-------Polygons--------//
//polygons usa latitude e longitude
//polygons são poliguinos ou seja formas geometricas no mapa
// polyglines desenhando linhas no mapa
//cria os pontos definifdo pra criação do polygono
//points:[latitude longitude]
//poligon conecta o primeiro ponto com o ultimo ponto,

//-------PolyLines--------//
//polynes nãoo possuiem fillColllor pois este não desenham formas
//caso queira exibir determiando local dentro do app, ou como chegar em determinado
//local usa se polyline
